/*
  Random "bad contact" flicker on one tube. Now picks from all six, and
  restores that tube to its own brightness (the seconds tubes carry the trim).
*/
void glitchTick() {
